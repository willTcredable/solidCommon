...
public enum ErrorCodes {
    ...
    // General Codes
    SUCCESS("0", "Success"),
    FAILED_TO_GET_RESPONSE_FROM_PARTNER("500000", "Failed to get response from partner : "),
    SYSTEM_ERROR("500000", "Failed to process your request"),
    PRODUCT_NOT_FOUND("500101", "Product not found"),
    FAILED_TO_GET_RESPONSE_FROM_CHANNEL("500101", "Failed to get response from channel"),
